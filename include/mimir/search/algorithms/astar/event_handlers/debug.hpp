...
private:
    ...
    void on_generate_state_relaxed_impl(State state, GroundAction action, Problem problem, const PDDLFactories& pddl_factories) const;

    void on_generate_state_not_relaxed_impl(State state, GroundAction action, Problem problem, const PDDLFactories& pddl_factories) const;

    void on_close_state_impl(State state, Problem problem, const PDDLFactories& pddl_factories) const;
    ...
    void on_solved_impl(const GroundActionList& ground_action_plan, const PDDLFactories& pddl_factories) const;
...
public:
    explicit DebugAStarAlgorithmEventHandler(bool quiet = true) : StaticAStarAlgorithmEventHandlerBase<DebugAStarAlgorithmEventHandler>(quiet) {}
};
