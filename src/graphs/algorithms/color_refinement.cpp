...
{
    return out << fmt::format("CertificateColorRefinement(canonical_coloring=[{}], canonical_compression_function={})",
                              fmt::join(element.get_canonical_coloring(), ", "),
                              element.get_canonical_compression_function());
}
