...
bool GroundConditionStrips::is_applicable(const FlatBitset& fluent_state_atoms,
...
FlatBitset& GroundEffectStrips::get_positive_effects() { return positive_effects; }

const FlatBitset& GroundEffectStrips::get_positive_effects() const { return positive_effects; }

FlatBitset& GroundEffectStrips::get_negative_effects() { return negative_effects; }

const FlatBitset& GroundEffectStrips::get_negative_effects() const { return negative_effects; }

ContinuousCost& GroundEffectStrips::get_cost() { return cost; }

const ContinuousCost& GroundEffectStrips::get_cost() const { return cost; }
...
const ContinuousCost& GroundEffectConditional::get_cost() const { return cost; }
...
const GroundConditionStrips& GroundActionImpl::get_strips_precondition() const { return strips_precondition; }

GroundEffectStrips& GroundActionImpl::get_strips_effect() { return strips_effect; }

const GroundEffectStrips& GroundActionImpl::get_strips_effect() const { return strips_effect; }

GroundEffectConditionalList& GroundActionImpl::get_conditional_effects() { return conditional_effects; }

const GroundEffectConditionalList& GroundActionImpl::get_conditional_effects() const { return conditional_effects; }

bool GroundActionImpl::is_dynamically_applicable(State state) const
{  //
    return GroundConditionStrips(get_strips_precondition()).is_dynamically_applicable(state);
}

bool GroundActionImpl::is_statically_applicable(const FlatBitset& static_positive_atoms) const
{  //
    return GroundConditionStrips(get_strips_precondition()).is_statically_applicable(static_positive_atoms);
}
