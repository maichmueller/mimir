...
def test_lifted_conjunction_grounder():
    ...
    conjunction_grounder = LiftedConjunctionGrounder(
        problem,
        goal_variables,
        StaticLiteralList(),
        goal_lifted,
    ...
    applicable_action_generator = LiftedApplicableActionGenerator(
        pddl_parser.get_problem(), pddl_parser.get_pddl_repositories()
    )
