...
PYBIND11_MAKE_OPAQUE(pymimir::EffectConditionalList);
PYBIND11_MAKE_OPAQUE(pymimir::GroundEffectConditionalList);
PYBIND11_MAKE_OPAQUE(pymimir::GroundEffectLiteralList<pymimir::Fluent>);
PYBIND11_MAKE_OPAQUE(pymimir::GroundEffectLiteralList<pymimir::Derived>);
