...
void init_function(py::module& m)
{
    ...
    class_<FunctionSkeletonImpl>(m, "FunctionSkeleton")  //
        .def("__str__", [](const FunctionSkeletonImpl& self) { return fmt::format("{}", self); })
        .def("__str__", [](const FunctionSkeletonImpl& self) { return fmt::format("{}", self); })
    ...
    class_<FunctionImpl>(m, "Function")  //
        .def("__str__", [](const FunctionImpl& self) { return fmt::format("{}", self); })
        .def("__str__", [](const FunctionImpl& self) { return fmt::format("{}", self); })
    ...
    class_<GroundFunctionImpl>(m, "GroundFunction")  //
        .def("__str__", [](const GroundFunctionImpl& self) { return fmt::format("{}", self); })
        .def("__str__", [](const GroundFunctionImpl& self) { return fmt::format("{}", self); })
