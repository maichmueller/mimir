...
TEST(CistaTests, CistaDynamicBitsetConstructorCopyTest)
{
    // Test size constructor
    size_t num_bits = 2;
    auto builder = cista::raw::dynamic_bitset<uint64_t>(num_bits);
    builder.set(1);

    // Test Builder
    auto copy_builder = cista::raw::dynamic_bitset<uint64_t>(builder);
...
TEST(CistaTests, CistaDynamicBitsetAssignmentTest)
{
    // Test size constructor
    size_t num_bits = 2;
    auto builder = cista::raw::dynamic_bitset<uint64_t>(num_bits);
    ...
    // Test Builder
    auto tmp_builder = cista::raw::dynamic_bitset<uint64_t>();
    tmp_builder = builder;
...
TEST(CistaTests, CistaDynamicBitsetEqualTest)
{
    auto builder1 = cista::raw::dynamic_bitset<uint64_t>();
    builder1.set(42);

    auto builder2 = cista::raw::dynamic_bitset<uint64_t>();
    builder2.set(42);
    builder2.set(64);

    auto builder3 = cista::raw::dynamic_bitset<uint64_t>();
    builder3.set(42);
...
TEST(CistaTests, CistaDynamicBitsetIsSupersetTest)
{
    auto bitset_1 = cista::raw::dynamic_bitset<uint64_t>();
    bitset_1.set(1);
...
TEST(CistaTests, CistaDynamicBitsetShrinkToFitTest)
{
    auto builder = cista::raw::dynamic_bitset<uint64_t>(250);
    builder.set(42);
...
TEST(CistaTests, CistaDynamicBitsetUnsetAllTest)
{
    auto builder = cista::raw::dynamic_bitset<uint64_t>(250);
    builder.set(42);
    EXPECT_EQ(builder.blocks_.size(), 4);
...
TEST(CistaTests, CistaDynamicBitsetSetTest)
{
    // Is included in CistaDynamicBitsetGetTest
}

TEST(CistaTests, CistaDynamicBitsetNotTest)
{
    auto bitset = cista::raw::dynamic_bitset<uint64_t>();
    bitset.set(1);
...
TEST(CistaTests, CistaDynamicBitsetOrTest)
{
    // B1  B2  R
    // 0 & 0 = 0
    // 1 & 0 = 1
...
TEST(CistaTests, CistaDynamicBitsetOrEqualTest)
{
    // B1  B2  R
    // 0 & 0 = 0
    // 1 & 0 = 1
...
TEST(CistaTests, CistaDynamicBitsetAndTest)
{
    // B1  B2  R
    // 0 & 0 = 0
    // 1 & 0 = 0
